...
function App() {
    ...
    const [sounds, setSounds] = createSignal<Array<{
        id: string;
    ...
    const addTestSound = () => {
        ...
        const sound = new Howl({
            src: ['https://assets.mixkit.co/sfx/preview/mixkit-retro-game-emergency-alarm-1000.mp3'],
            loop: true,
            volume: 0.2,
            onload: () => {
                sound.play();
            ...
            <div style={{ "max-width": "1200px", "margin": "0 auto" }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        Listener Position: ({listenerPos().x.toFixed(2)}, {listenerPos().y.toFixed(2)})
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <ul style={{ "color": "#94a3b8", "line-height": "1.6" }}>
                        <li>• Click anywhere in the room to move the listener (blue circle)</li>
                        <li>• Click on sound sources (purple circles) to randomize their positions</li>
